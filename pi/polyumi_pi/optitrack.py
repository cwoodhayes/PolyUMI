...
2. Connect esync's ground to the pi's ground, and esync's signal to pin 40 (using a pigtail bnc cable)
...
7. ORDER IS VERY IMPORTANT: unplug pin 40 (optitrack signal), and ONLY THEN unplug optitrack ground.
