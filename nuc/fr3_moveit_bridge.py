...
class Fr3MoveItBridge(Node):
    ...
    def __init__(self, **kwargs):
        ...
        # Unconditional: policy_client_node publishes ONE wire format, so a stack running the servo
        # simply never sends a PoseArray here and this subscription stays idle.
